      subroutine radiated_xn_h2_47(wsqtest,qsqtest,radval)
c
c
      implicit none
      real radval
...
c   
      ...
      data filename1 /'extern_files/extern_H2_4.73_W2.0-2.8_Q20.8-1.7.out'/
      parameter (wpt_h2_47_1=9)
      parameter (q2pt_h2_47_1=10)
...
c   extern_H2_4.73_W1.5-2.6_Q21.9-2.7.out
      ...
      data filename2 /'extern_files/extern_H2_4.73_W1.5-2.6_Q21.6-2.7.out'/
      parameter (wpt_h2_47_2=12)
      parameter (q2pt_h2_47_2=12)
...
c extern_files/extern_H2_4.73_W1.2-2.4_Q22.7-3.5.out
      ...
      data filename3 /'extern_files/extern_H2_4.73_W1.2-2.4_Q22.7-3.6.out'/
      parameter (wpt_h2_47_3=13)
      parameter (q2pt_h2_47_3=10)
...
c extern_H2_4.73_W1.2-1.9_Q23.5-5.0.out
      ...
      data filename4 /'extern_files/extern_H2_4.73_W1.1-2.0_Q23.5-5.0.out'/
      parameter (wpt_h2_47_4=10)
...
c
     ...
     &            sigrad_elas,sigrad_qe,sigrad_inel,t1,t2,t3,t4,t5,t6
        ...
        fac_h2_47_1(i,j) = sigrad_all/sigborn
         ...
         write(81,101) W_h2_47_1(i),q2_h2_47_1(j),fac_h2_47_1(i,j)
     >,ep,theta,sigborn
       enddo
       enddo    
      close(21)
     ...
     &            sigrad_elas,sigrad_qe,sigrad_inel,t1,t2,t3,t4,t5,t6
       Wsq = Mp**2 + 2d0*Mp*(e-ep) - q2_h2_47_2(j)
        fac_h2_47_2(i,j) = sigrad_all/sigborn
         ...
         write(81,101) W_h2_47_2(i),q2_h2_47_2(j),fac_h2_47_2(i,j)
     >,ep,theta,sigborn
 101     format(6(f10.5,','))
       enddo
       enddo    
c
     ...
     &            sigrad_elas,sigrad_qe,sigrad_inel,t1,t2,t3,t4,t5,t6
        ...
        fac_h2_47_3(i,j) = sigrad_all/sigborn
         ...
         write(81,101) W_h2_47_3(i),q2_h2_47_3(j),fac_h2_47_3(i,j)
     >,ep,theta,sigborn
       enddo
       enddo    
c
     ...
     &            sigrad_elas,sigrad_qe,sigrad_inel,t1,t2,t3,t4,t5,t6
        ...
        fac_h2_47_4(i,j) = sigrad_all/sigborn
         ...
         write(81,101) W_h2_47_4(i),q2_h2_47_4(j),fac_h2_47_4(i,j)
     >,ep,theta,sigborn
       enddo
       enddo    
c
